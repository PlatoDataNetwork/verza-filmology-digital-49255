        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col items-center gap-3 mb-8 md:mb-12 -mt-4 md:mt-0">
            <a 
              ...
              className="flex items-center justify-center gap-3 w-64 px-6 py-3.5 bg-black text-white rounded-xl hover:opacity-90 transition-opacity text-base font-semibold"
            >
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-3 w-64 px-6 py-3.5 bg-[#01875f] text-white rounded-xl hover:opacity-90 transition-opacity text-base font-semibold"
            >
              <svg className="w-7 h-7" viewBox="0 0 24 24" fill="currentColor">
