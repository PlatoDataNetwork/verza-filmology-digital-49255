...
export const Content = () => {
  ...
  return (
    <section 
      ...
      className={`py-8 md:py-10 lg:py-12 bg-background transition-all duration-700 ${
    ...
    >
      <div className="container mx-auto px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Content Roadmap - Mobile-optimized grid */}
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6 mb-8 md:mb-20">
            <div className="p-5 md:p-8 bg-muted/50 rounded-xl md:rounded-3xl active:bg-muted/70 md:hover:bg-muted/60 transition-colors touch-manipulation">
              <div className="w-10 h-10 md:w-12 md:h-12 rounded-lg md:rounded-2xl bg-primary/10 flex items-center justify-center mb-3 md:mb-6">
              ...
              <h3 className="text-base md:text-xl font-semibold mb-1.5 md:mb-2 text-foreground">Premium drama</h3>
            ...
            <div className="p-5 md:p-8 bg-muted/50 rounded-xl md:rounded-3xl active:bg-muted/70 md:hover:bg-muted/60 transition-colors touch-manipulation">
              ...
              <h3 className="text-base md:text-xl font-semibold mb-1.5 md:mb-2 text-foreground">Multiple genres</h3>
              <p className="text-xs md:text-sm text-muted-foreground leading-relaxed">
            ...
            <div className="p-5 md:p-8 bg-muted/50 rounded-xl md:rounded-3xl active:bg-muted/70 md:hover:bg-muted/60 transition-colors touch-manipulation">
              ...
              <h3 className="text-base md:text-xl font-semibold mb-1.5 md:mb-2 text-foreground">Licensed content</h3>
              <p className="text-xs md:text-sm text-muted-foreground leading-relaxed">
            ...
            <div className="p-5 md:p-8 bg-muted/50 rounded-xl md:rounded-3xl active:bg-muted/70 md:hover:bg-muted/60 transition-colors touch-manipulation">
              ...
              <h3 className="text-base md:text-xl font-semibold mb-1.5 md:mb-2 text-foreground">Additional media</h3>
              <p className="text-xs md:text-sm text-muted-foreground leading-relaxed">
